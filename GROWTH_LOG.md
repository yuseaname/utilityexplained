...
## Entry 27 — clicks-first monetization pass: ads/affiliate separation + CTR placements (2026-09-07)

**Decision research (agency, 2 seats + 1 transport-stall repair):** HouseFresh teardown (verified, cited) — verdict-first blocks, button CTAs repeated per section (4+ in first half of page), curated 3–5 picks; no citable button-vs-text or outbound-CTR benchmark exists anywhere retrievable — site must build its own baseline from `affiliate_click` events. Ads-vs-affiliate: Amazon policy does NOT prohibit AdSense beside affiliate links (verified from OA + Program Policies); arithmetic alone can't justify removal at this traffic, but measurement integrity (clean CTR baseline) + unread JS-gated Participation Requirements + UX all favor clean money pages. Incident logged: glm-xo-3 transport hang mid-run — killed at wall-limit, same-seat continue-session repair recovered the full brief in one round (note recorded).

**Shipped:**
1. **AdSense/affiliate separation** — head.html Auto Ads loader now skips any page carrying product-box/amazon placements (or `no_ads: true` front-matter); 44 money pages render zero ad scripts, informational pages keep ads. Blast radius verified against committed build (alias stubs ad-free in both; delta = exactly the monetized set).
2. **Water ladder completed on top traffic pages** — leak-indicator (95 v/30d): single $559 Flo box → 3-rung ladder (Govee → Flume 2 → Flo, pro-install now stated); 06-water (120): +Flume 2 mid-rung box; water-meter-running (133): +Flume 2 inline; 30-spike (171): old-gen KP115 inline → Tapo P110M 2-pack box (current gen).
3. **Early-link CTR pass (HouseFresh pattern)** — +10 inline placements on 6 top-traffic pages (early link right after Quick Answer narrative + closing CTA at outro/hub paragraph; nothing inside bold answer blocks, nothing inside the 4-article rule zone); +4 early inline links on the SQ-072 buyer-intent articles (pillar, Sense guide, KAW alternatives, Flume-vs-Flo-vs-Phyn) — all had first placement at 31–67% page depth. CCF page (108 v/30d) monetized for the first time (Govee inline) **with disclosure added** (was the only monetized page without one).
4. **ASIN re-verification sweep (live, 2026-09-07):** P4400 $27.50 in stock (confirms Entry 26, re-confirms the Aug-31 flag was rotation outage); P4456 B0C4G7QVZT $39.99 (low stock); Govee 5-pack $59.98 (3,000+/mo); Tapo P110M 2pk $17.98; Vue 3 **$99.99** (far below the $169–180 band in prose — pillar says "$150–180", watch for sale-vs-MSRP drift); KP115 $12.99; Flo $559; Flume 2 $199; Nest 4th gen $239.99; Midea Cube w/Pump $249.99. All placements live; no swaps needed.
5. **GSC sitemap submitted by owner 2026-09-07** (was owner-action #1 since Entry 24). Remaining owner actions: mark `affiliate_click` as GA4 key event; verify Associates statement wording + April-2026 OA changes at next login.

**Net:** 135 → 157 affiliate links (public-build basis), 43 → 44 monetized pages, 0 → 44 ad-free money pages. All checks green: build, image paths, content audit (102/52, zero new flags), rendered-output lint, tracking attributes verified in HTML (tag/rel/data-rybbit on every new link).

**What was NOT redone (already shipped in Entry 26, strategy doc was stale):** the four "days 8–30" articles, flagship C3/C4, spoke→hub links, disclosures on 11/46, dehumidifier box — all verified present before this pass; duplicate article-draft dispatch killed on discovery.

## Entry 28 — next-10 article wave: SERP-gap research → 10 new money-cluster articles + 49 images, Prime hard filter enforced (2026-09-12)

**Decision research (agency, 4 runs + repairs):** three-seat parallel research — SERP-gap sweep (17 candidates, live Bing/Brave SERPs), competitor teardown (8 recurring domains across slate-topic SERPs), Prime-filtered product verification (mobile `/gp/aw/d/` buy-box reads — search-tile Prime signals proved unreliable: AES R8 read Prime from a tile, FBM at the buy box). Slate decisions per owner: deepen money clusters, 6 buyer + 4 informational mix, Prime eligibility as a hard filter. Killed with evidence: smart-thermostat and humidifier best-ofs (big-media saturated), heat-pump water heater as buyer piece (no Prime-eligible Amazon product exists). Deployed 2026-09-12 via commit 89473755 + Hostinger deploy + CI IndexNow (HTTP 200); this push also published the four pending Sep-7 local commits (Entries 27-era monetization/analytics).

**Shipped (10 articles, 6 buyer / 4 informational, water-cluster-heavy by design):**
1. **Buyer:** outdoor faucet covers (nabreeli/MANUMARINE, winter window Sept–Nov); faucet aerators (Niagara Tri-Max + dual-spray — weakest commercial SERP found all run); MERV 11 filter 6-packs (Aerostar 11 + cheaper MERV 13 sibling, both sold-by-Amazon); thermal camera for DIY audits (Thermal Master P1, fences both ways to Entry-26-era 47- checklist + FLIR pick); low-flow showerheads (Niagara Earth Spa — Wirecutter publicly vacated the low-flow angle, cited); dual-flush kits (Danco HYR460, compatibility-first guide); sump pump battery backup (WAYNE ESP25n, runtime arithmetic; Watchdog rejected FBM/no-Prime, stated honestly).
2. **Informational:** electric blanket vs space heater cost math ($6.60 vs $66 continuous/$25–40 cycled; bars image regenerated to match math exactly); water-heater-blanket payback (honest marginal-on-modern-tanks verdict); tankless vs tank bill impact (zero affiliate links — Rinnai listing unverified at research time); smart-sprinkler piece deferred to spring (bench, verified).
3. **Images:** 36 house line-art heroes/diagrams (nano-banana for art, gpt-image-2 for in-image text, per owner instruction) + 13 realistic product shots restyled from the real captured Amazon listing photos via nano-banana-edit — registered in data/product_images.yaml (20 → 33 entries) so every product box renders its image.
4. **Existing-article maintenance:** reverse fences added on 47-check-energy-leaks, draft-sealing guide, space-heater guide, what-MERV; stale $15–25 blanket band corrected to ~$30–35 (plus its sub-1-year payback claim → 1–2 years); **Vue 3 price bands fixed $150–180 → ~$100–200 across 7 occurrences / 3 articles** (closes the Entry-27 drift watch).

**Quality gates:** cross-family review 88/100 (5 PASS / 2 REVISE; fixes applied: tankless net-vs-gross $2,900→$2,000, unsourced Reddit-consensus claim softened, EPA flush-figure reattribution); Boss re-verified the third seat's batch; every product number traced to buy-box evidence; zero "we tested" claims (grep-verified); build, image-path, rendered-output, and content-audit checks all green (zero new flags); ads auto-excluded on all 10 money pages via the Entry-27 loader logic.

**Net:** 157 → 179 affiliate placements, 44 → 53 monetized pages (tankless intentionally unmonetized), 0 → 10 new SERP entries targeting weak/forum/retail-wall SERPs. Known follow-ups: Frost King SP57 stock runs thin on the common size (recheck at next pass); DOE energysaver/water-heating URL intermittently 404s (consider archive fallback); IndexNow pickup watch added below.

**Fleet notes (incident ledger):** ollama-chat seats starve when dispatched concurrently (zero assistant turns ×3 waves; solo probe 1.6s) — cap at one ollama seat per dispatch wave until understood; glm-or-1 stalled twice mid-turn; dsv4-wing-1/2 delivered 7/10 articles; Boss self-inflicted seat-collision documented (never dispatch onto a seat another live dispatcher owns).

## Entry 29 — follow-ups: EV Level-1 + smart-sprinkler articles, harness reasoning fix, citation maintenance (2026-09-12)

**Shipped (Entry 28 bench pieces, both live):**
1. **Level 1 EV Charging: What It Actually Costs on Your Electric Bill** (Electricity) — the rates/EV-cluster gap Entry 28 flagged; Poniie PN2500 B0C619YRRM (~$66, FBA) as the measuring tool; outlet math (120 V × 12 A = 1,440 W; 8 h ≈ 11.5 kWh ≈ $2.11; $46–64/mo commuter band at the EIA average); fences to ev-charging-impact-electric-bill ×4 with L2 payback explicitly deferred; L1-vs-L2 head-to-head table added per review.
2. **Do Smart Sprinkler Controllers Actually Save Water?** (Water) — question-space entry auditing the unsourced "~32% savings" affiliate claim against live EPA WaterSense (no "32%" exists; EPA publishes "up to 15,000 gallons"/yr — verified 2026-09-12, page updated 2026-03-05); Rachio 3 B07CZ5K355 (~$249, sold-by-Amazon, 16-left stock caveat) + Orbit B-hyve XD B09YFWNH9Y (~$36, sold-by-Amazon, honestly framed as a one-line hose timer); conservative 7,600-gal/yr payback math with the EPA-implied ~30,000-gal baseline stated; spring search window now has index age behind it.
3. **Images:** 5 editorial/diagram + 3 realistic product shots (Rachio/Orbit restyled from live Amazon photos; Poniie illustrative — fresh fetches bot-walled); product_images.yaml 33 → 36 entries.
4. **Maintenance:** DOE energysaver/water-heating (intermittent 404) now carries Wayback fallbacks (2026-08-08 capture) in 3 articles (blankets, tankless, 07-gas-bill); Frost King SP57 re-check still "Only 1 left" — box hedge stands, re-check next pass.
