...
sources:
  ...
  - https://www.eia.gov/dnav/ng/ng_pri_sum_a_EPG0_PRS_DMcf_a.htm (EIA natural gas residential price summary by state, retrieved 2026-08-29)
  - https://www.eia.gov/energyexplained/units-and-calculators/british-thermal-units.php (EIA Btu conversion factors, retrieved 2026-08-29)
  - https://www.eia.gov/consumption/residential/data/2020/ (EIA RECS 2020, Table CE5.4, retrieved 2026-08-29)
...
1. **Usage:** compare meter readings and billed therms against the conversion factor on the bill (see below).
2. **Rates:** multiply usage by each per-unit rate yourself and confirm the line totals.
...
2. Your bill states a conversion factor of **1.037 therms/Ccf**.
3. Billed therms = 60 Ccf × 1.037 = **62.2 therms**.
4. If your supply rate is $1.40/therm, the supply charge = 62.2 × $1.40 = **$87.08**.
...
Comparing guides on this site: [Why Is My Gas Bill So High?](/blog/07-gas-bill-too-high/) uses a worked winter example reaching about 200 therms for a well-heated home in a cold month — the upper part of the range above — and keeps heating separate from water heating. [MCF vs CCF vs Therms](/blog/mcf-vs-ccf-vs-therms-on-gas-bill/) quotes winter volume in Ccf (100–150 Ccf), which is the same ballpark expressed in volume units: 100–150 Ccf ≈ 104–156 therms at the 1.037 factor. All three pages describe the same seasonal reality: deep-winter peaks in the low-to-mid hundreds of therms for homes that heat with gas, a 10–40 therm summer baseline, and month-to-month comparisons made within the same season.

## Sources

1. [EIA — U.S. Natural Gas Residential Consumption (monthly)](https://www.eia.gov/dnav/ng/hist/n3010us2m.htm) — monthly residential consumption, 2020–2024 seasonal shares (retrieved 2026-08-29).
2. [EIA — Price of Natural Gas Delivered to Residential Consumers](https://www.eia.gov/dnav/ng/hist/n3010us3a.htm) — annual U.S. residential price (retrieved 2026-08-29).
3. [EIA — Natural Gas Residential Price Summary, by state](https://www.eia.gov/dnav/ng/ng_pri_sum_a_EPG0_PRS_DMcf_a.htm) — 2025 state prices (retrieved 2026-08-29).
4. [EIA — British Thermal Units (Btu)](https://www.eia.gov/energyexplained/units-and-calculators/british-thermal-units.php) — natural gas heat content and therm conversion (retrieved 2026-08-29).
5. [EIA — RECS 2020, Consumption & Expenditures Tables (CE5.4)](https://www.eia.gov/consumption/residential/data/2020/) — annual household natural-gas end-use consumption by climate region (retrieved 2026-08-29).
