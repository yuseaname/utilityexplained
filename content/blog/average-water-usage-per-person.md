...
<h2 id="breakdown">Where the water goes</h2>
<table>
              <thead>
                <tr>
                  <th>Use</th>
...
<h2 id="factors">Factors that change your baseline</h2>
<p>
...
<h2 id="measure">How to estimate your own usage</h2>
<p>
...
<h2 id="fixture-rates">Know your fixture flow rates</h2>
<p>
...
<h2 id="apartments">Apartment vs. house usage</h2>
<p>
...
<h2 id="household-changes">Household changes that affect usage</h2>
<p>
...
<h2 id="set-goals">Setting a realistic usage target</h2>
<p>
...
<h2 id="leak-baseline">Establish a no-use baseline</h2>
<p>
...
<h2 id="lower-usage">Ways to lower usage without major changes</h2>
<ul>
...
{{< faq "Is 100 gallons per person per day too high?" >}}
...
{{< faq "How can I tell if leaks are affecting my usage?" >}}

Check the meter when no water is in use. If the meter still moves, you likely have a leak.

{{< /faq >}}

{{< faq "Do low-flow fixtures make a big difference?" >}}
