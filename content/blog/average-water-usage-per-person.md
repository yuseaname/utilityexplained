...
Compare the same statement fields from a similar earlier period:

- billed days and meter-read status;
- household and occupancy changes;
- outdoor watering or seasonal activity;
