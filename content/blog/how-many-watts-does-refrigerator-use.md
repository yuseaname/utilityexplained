---
title: "How Many Watts Does a Refrigerator Use? (and How to Measure Yours Exactly)"
...
image: "/images/articles/how-many-watts-does-refrigerator-use/how-many-watts-does-refrigerator-use_hero_v2.webp"
keywords: ["how many watts does a refrigerator use", "refrigerator power consumption", "how many kwh does a fridge use", "kill a watt meter", "measure appliance energy use"]
sources:
  - https://www.eia.gov/tools/faqs/faq.php?id=97&t=3 (retrieved 2026-08-31)
  - https://www.eia.gov/electricity/monthly/epm_table_grapher.php?t=epmt_5_03 (retrieved 2026-08-31)
  - https://www.energystar.gov/products/refrigerators (retrieved 2026-08-31)
  - https://www.pnm.com/checkoutsavings (retrieved 2026-08-31)
  - https://www.libraryjournal.com/story/the-latest-public-library-loan-electricity-meters (retrieved 2026-08-31)
---
...
{{< product-box asin="B07HM9S6ZR" name="P3 P4460 Kill A Watt EZ Electricity Usage Monitor (3-Pack)" label="Plug-in kWh meter" description="Plug-in watt meter that reads live watts and cumulative kWh over time; enter your own utility rate for an on-device cost estimate. Works on any standard 120V outlet — no installation, landlord-friendly, and handy for one measurement on each of several appliances (sold as a 3-pack)." button="Check price on Amazon" >}}

After 24 hours, write down the kWh figure and take it to the cost table below. That number, measured under your kitchen's conditions, beats any table on the internet — including the one above.
...
{{< product-box asin="B08LN3C7WK" name="Kasa KP115 Smart Plug Slim with Energy Monitoring" label="Monitoring smart plug" description="Wi-Fi smart plug with built-in energy monitoring: live watt readings and cumulative kWh trending in the Kasa app. Standard 120V outlet, no wiring, renter-friendly — useful for continuous logging of a single appliance like a refrigerator." button="Check price on Amazon" >}}

One plain-language caution for every tool here: a meter measures; it doesn't fix or save anything by itself. The readout is information — what changes the bill is what you do after. For the wider monitoring toolbox, see this site's [best smart plugs for standby power and monitoring](/blog/50-best-smart-plugs-standby-power/) and the [whole-home energy monitor guide](/blog/do-home-energy-monitors-save-money/).
...
None of that is a promise — the gain depends on how wrong the setup was, which only the measurement can tell you. The division of labor: the meter finds the number, the fix changes the number, neither does the other's job. The same logic scales up: once plug loads are measured, the big-league consumers in the [complete guide to lowering your electric bill](/blog/how-to-lower-electric-bill-complete-guide/) — HVAC especially — dominate what's left.
...
1. [How much electricity does an American home use?](https://www.eia.gov/tools/faqs/faq.php?id=97&t=3) — U.S. Energy Information Administration (10,791 kWh per residential customer, ≈899 kWh/month, 2023). HTTP 200.
2. [Electric Power Monthly, Table 5.03 — Average Price of Electricity](https://www.eia.gov/electricity/monthly/epm_table_grapher.php?t=epmt_5_03) — U.S. Energy Information Administration (residential 18.34 cents/kWh, June 2026). HTTP 200.
3. [Refrigerators](https://www.energystar.gov/products/refrigerators) — ENERGY STAR (refrigerators over 15 years old cost about $95/year more; coil cleaning and clearance guidance). HTTP 200.
4. [Checkout Savings — Kill A Watt Energy Meter](https://www.pnm.com/checkoutsavings) — PNM (utility-sponsored free Kill A Watt meter checkout program, borrowed like a library book). HTTP 200.
5. [The Latest Public Library Loan? Electricity Meters](https://www.libraryjournal.com/story/the-latest-public-library-loan-electricity-meters) — Library Journal (public libraries lending Kill A Watt meters). HTTP 200.
