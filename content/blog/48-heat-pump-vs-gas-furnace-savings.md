...
1. From your electric bill: all-in ¢/kWh (total electric charges ÷ total kWh, not just the energy line).
2. From your gas bill: $/therm (gas cost ÷ therms delivered; use a winter month).
3. Candidate equipment: AFUE for the furnace; seasonal COP estimate for the heat pump (HSPF2 ÷ 3.4 gives a rough COP; or use the NEEP list's 5°F COP as a cold-weather floor).
4. Apply the breakeven rule above—and if the answer is close, weigh installation deltas and program money, not fuel alone.
...
{{< product-box asin="B0D5BBYRJM" name="Google Nest Learning Thermostat (4th gen)" label="The one control both systems share" description="Works with gas forced air and heat pumps, including aux/backup heat and dual-fuel setups (up to 2 cool / 3 heat stages, per Google's compatibility docs). On a dual-fuel system this is the device that executes your balance-point decision from the math above." button="Check price on Amazon" >}}

For heat-pump owners specifically, a [heat pump that seems to run all day in winter](/blog/heat-pump-running-all-day-in-winter/) is usually a sizing, balance-point, or aux-heat question—not automatically a broken system.

## Questions Before Signing

1. What load calculation and design conditions support this equipment size?
2. What work is included for ducts, electrical service, gas, controls, and permits?
3. For heat pumps: what is this model's capacity and COP at my design temperature (NEEP list)?[5]
4. What maintenance and commissioning steps are required for warranty and safe operation?
5. Which incentives are documented as applicable—and is anyone still quoting the ended 25C credit?
...
{{< faq "Is a heat pump or a gas furnace cheaper to run?" >}}
There is no national answer—there is a local one. Divide your electric ¢/kWh by your gas $/therm; if that ratio is below 3.41 × COP ÷ AFUE for your candidate equipment, the heat pump is cheaper per unit of heat, and vice versa. At January 2026 national averages the 96% furnace wins; in cheap-electricity regions the heat pump does. The formula section above walks the arithmetic.[7][8]
{{< /faq >}}

{{< faq "Is the federal heat pump tax credit still available?" >}}
No. The 25C credit (30% up to $2,000) does not apply to equipment placed in service after December 31, 2025, under the 2025 federal tax law. State Home Energy Rebate programs and utility rebates continue where administered—verify current terms with the program administrator. Pages still quoting the credit as live are out of date.[10]
{{< /faq >}}

{{< faq "Do heat pumps work in cold climates?" >}}
...
1. [AHRI: 2023 Energy Efficiency Standards (SEER2/HSPF2 minimums and the test-procedure change)](https://www.ahrinet.org/2023-energy-efficiency-standards)
2. [U.S. Department of Energy: Heat Pumps](https://www.energy.gov/heat-pumps)
3. [DOE FEMP: Purchasing Energy-Efficient Residential Furnaces (80% AFUE federal minimum)](https://www.energy.gov/cmei/femp/purchasing-energy-efficient-residential-furnaces)
...
11. [Trane: Heat Pump and Furnace Pricing Guide (national ranges, manufacturer-published)](https://www.trane.com/residential/en/pricing/pricing-guide/)
