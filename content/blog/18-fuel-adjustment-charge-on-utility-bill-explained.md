---
title: "Fuel Adjustment Charge on Utility Bill Explained"
...
The fuel adjustment charge (FAC) is a pass-through fee that moves with the utility's actual fuel costs, typically swinging **±15–30%** month to month. It's why two identical-usage bills can differ by $20–$80, and you can't dispute it — only reduce usage.

- **FAC is a direct pass-through** — utilities earn no profit on this charge
- **Natural gas prices drive most swings** — the fuel is tied to commodity markets
- **Can be negative in some months** — utilities credit back when fuel costs drop

See also: [Utility bill surcharges and riders explained](/blog/19-utility-bill-surcharges-and-riders-explained/).

That line item on your electric bill labeled "fuel adjustment," "fuel cost recovery," "energy cost adjustment," or "purchased power adjustment" might seem minor — until it doubles overnight and adds $60 to your bill. The fuel adjustment charge is the single most volatile component of your utility bill, and it's the most common reason your electric costs spike even when your electricity usage stays exactly the same.

## What Is the Fuel Adjustment Charge?

The fuel adjustment charge is a pass-through fee on your utility bill that reflects the utility's actual cost of fuel used to generate or purchase electricity. Unlike the base rate (which is set by your state's public utility commission through a formal rate case), the fuel adjustment fluctuates monthly or quarterly based on wholesale fuel market prices. It sits next to your [delivery and supply charges](/blog/24-delivery-charge-vs-supply-charge-utility-bill/), not inside them.
...
This charge is particularly significant because roughly 60% of US electricity is generated from fossil fuels: about 42% from natural gas, 15% from coal, and 3% from petroleum (U.S. EIA, 2025). When the price of any of these fuels changes, the cost cascades directly onto your electric bill through the fuel adjustment mechanism.
...
## What Drives Fuel Adjustment Costs Up or Down
...
- **Seasonal demand:** Natural gas prices typically peak in winter (heating demand) and summer (power plant cooling demand). The Henry Hub natural gas spot price averages $2.50 to $4.00 per MMBtu in normal years but has spiked above $9.00 during supply crises (U.S. EIA).
...
### What FAC Looks Like on a 900 kWh Bill

| Fuel Adjustment Rate | Monthly FAC Cost (900 kWh) |
| --- | --- |
| $0.01/kWh | $9.00 |
| $0.02/kWh | $18.00 |
| $0.03/kWh | $27.00 |
...
A swing from $0.02 to $0.04 per kWh adds $18 to that bill — with zero change in your behavior.
...
## Does the Fuel Adjustment Affect Gas Bills Too?

Natural gas utility customers see a similar concept on their gas bills, though it's labeled differently. Instead of "fuel adjustment," gas bills typically show a "cost of gas" or "purchased gas adjustment" charge that reflects the utility's wholesale natural gas procurement costs. This is the [gas supply portion of your bill](/blog/gas-delivery-charge-vs-supply-charge/), separated from the local delivery fee.
...
- **Shift to off-peak hours:** If you're on a [time-of-use rate plan](/blog/08-time-of-use-electricity/), running heavy loads after 9 p.m. can lower the kWh subject to peak fuel adjustment rates.

Because the fuel adjustment is a pass-through, you can't negotiate it or shop around for a better rate within your utility's service territory. The only lever you control is your consumption. And while the FAC is volatile, the flat [customer charge](/blog/17-what-is-customer-charge-on-utility-bill/) on your bill is another fixed fee worth checking for accuracy each year.

## What to Check Next on Your Bill

1. **Find your current FAC rate.** Look under "Rates," "Tariffs," or "Schedule of Charges" on your utility's website. Most publish the current month's per-kWh fuel adjustment.
2. **Compare kWh month over month.** If usage is flat but the bill jumped, the FAC moved — not you. That's the signal the fuel adjustment is the cause.
3. **Audit the other pass-throughs.** FAC is one of several. Review your [surcharges and riders](/blog/19-utility-bill-surcharges-and-riders-explained/) and the full breakdown of [taxes, fees, and franchise charges](/blog/25-utility-bill-taxes-fees-franchise-charges-explained/) on the same bill.
4. **If the number looks wrong, file a complaint** with your state public utility commission. You can dispute calculation errors and incorrect meter reads, but not the price of natural gas itself.

For a full walkthrough of every line on your statement, see the [complete guide to understanding your utility bill](/blog/complete-guide-understanding-utility-bill/).
