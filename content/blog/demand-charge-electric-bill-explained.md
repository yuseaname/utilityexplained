...
<h2 id="quick-answer">The short answer (what a demand charge is)</h2>
<p>
...
<h2 id="demand-vs-energy">Demand vs energy: kW vs kWh in plain English</h2>
<p>
...
<h2 id="how-measured">How peak demand is measured</h2>
<p>
...
<h2 id="where-on-bill">Where demand charges appear on the bill</h2>
<p>
...
<h2 id="who-sees">Who usually sees demand charges (and who does not)</h2>
<p>
...
{{< faq "What is a demand charge on an electric bill?" >}}
...
{{< faq "How is peak demand measured?" >}}
...
{{< faq "Why is my demand charge high if my total usage is normal?" >}}

A single short spike can set the demand charge for the month even if your overall kWh is average.

{{< /faq >}}

{{< faq "Do all residential customers have demand charges?" >}}
...
{{< faq "Where do demand charges show on the bill?" >}}
