...
- **Don't ignore the notice** — the date on it is your deadline, and acting early gives you the most options

If your notice arrived yesterday, your first three steps are: call the utility, ask for a payment arrangement, and check your state's protections below.

## The Shutoff Process, Step by Step

A shutoff rarely happens overnight. In most states the utility must move through a set sequence, and each step gives you a chance to act.
...
Two things matter about this timeline. First, the notice period is where you have the most leverage — once the disconnection date passes, you are dealing with reconnection fees and deposits on top of the balance. Second, the rules are not the same for every service. Electric and natural gas are the most heavily regulated, because they are essential for heating and cooling, and most states have detailed rules about how and when they can be cut. Water is different: it is usually run by a city or local authority rather than a state-regulated company, and the rules vary far more sharply from one city to the next.

If you are behind on a bill, the single most useful thing you can do is read the notice and mark the date. That date is not a suggestion — it is the day the utility plans to act.
...
- **How to pay** or set up a payment arrangement
...
- **You usually have to apply or qualify.** The protection is not automatic for everyone — it often depends on income, enrollment in an assistance program, or a documented inability to pay.
- **It is a pause, not a forgiveness.** The balance does not disappear; the utility simply cannot cut you off during the protected period. You will still owe the money.
- **It typically covers electric and gas, not water.** Heating fuel is the focus, so water shutoffs are usually not covered by winter moratoria.

Some states also have summer heat protections, especially for elderly customers and people with medical conditions, that restrict shutoffs during extreme heat. The logic is the same as winter: cutting power in a heat wave can be dangerous.

If you live in a cold climate and are behind on your heating bill, call your utility and ask directly: "Does my state have a winter shutoff moratorium, and do I qualify?" That question costs nothing and can stop the process cold.
...
## How to Stop a Shutoff Today

If the notice is in your hand, you still have options. The most effective single move is to call the utility before the disconnection date and ask for a payment arrangement.

**What to ask for:**

- **A payment plan** — spreading the past-due balance over several months on top of your regular bill
- **A deferred payment** — pushing the due date back by a week or two if you are close to having the money
- **A deposit in exchange for keeping service** — some utilities will keep service on if you pay a deposit, especially if you have a history of late payments
- **A waiver of late fees** — many utilities will remove fees if you commit to a plan
...
> "I received a disconnection notice dated [date] for my [electric/gas/water] account. I cannot pay the full balance today, but I want to keep my service on. Can you set up a payment arrangement? I would like to pay [amount] on [date] and the rest over the next [number] months. Can you confirm that in writing and put the disconnection on hold while we set this up?"

If the first person cannot help, ask to speak to a supervisor or the customer assistance department. Persistence is not rudeness — it is how you get to the person who can actually approve a plan.
...
- **Same-day vs. next-day.** Some utilities restore service the same day if you pay early in the day; others schedule it for the next business day. Ask what the cutoff time is for same-day service.
- **Deposits may be required.** If you have a history of late payments or disconnections, the utility may require a [deposit](/blog/26-utility-deposit-explained/) before restoring service. This is separate from the balance and the reconnection fee.
- **You can negotiate the deposit.** If the deposit is more than you can pay, ask to pay it in installments or to have it reduced. Some utilities will lower a deposit if you agree to automatic payments or provide a letter of good credit from a previous utility.
- **Ask for fee waivers.** If you are on a low income or receiving assistance, some utilities will waive or reduce the reconnection fee. It never hurts to ask.

Reconnection is more expensive and more stressful than preventing the shutoff in the first place. If you are already disconnected, the fastest path is usually: call, pay what you can, ask for a plan for the rest, and ask for same-day service.
...
## Slammed with a Huge Bill You Don't Owe?

Sometimes the past-due notice is not about a bill you actually owe. If the amount looks wrong — far higher than your normal usage, or based on an estimate that does not match your meter — do not just pay it. A disputed bill can often pause the shutoff while it is investigated.
...
It depends on the utility and the time of day. Some restore service the same day if you pay early enough; others schedule it for the next business day. Ask what the cutoff time is for same-day service, and ask whether the reconnection fee can be reduced or waived if you are on a low income.
{{< /faq >}}
...
1. **Placement: after H2-1 (The Shutoff Process, Step by Step).** Concept: a horizontal timeline strip showing the five-step shutoff process — an unpaid bill, a written notice, a notice period, a disconnection date, and a reconnection. Style: clean flat vector illustration, warm neutral palette (soft blue, amber, gray), each step as a labeled card with a simple icon connected by an arrow. Composition: wide banner, left-to-right flow, generous white space, no text-heavy clutter — the labels should be short and legible at thumbnail size.

2. **Placement: after H2-3 or H2-4 (Winter Protections / Medical and Age Protections).** Concept: a shield icon set representing the four key protections — a snowflake for winter moratoria, a medical cross for medical certification, a heart or person icon for elderly protections, and a document for the written notice. Style: flat vector iconography, consistent line weight, muted blue and teal with warm amber accents, each icon inside a soft shield outline. Composition: a 2x2 grid of four shields, balanced and symmetrical, with a calm, reassuring tone.

3. **Placement: after H2-5 (How to Stop a Shutoff Today).** Concept: a three-step "call card" showing the immediate actions — call the utility, ask for a payment arrangement, and get it in writing. Style: flat vector illustration of a phone and a hand holding a written confirmation, warm and approachable, soft green and blue palette to signal action and hope. Composition: three numbered steps arranged vertically or in a row, each with a simple icon and a short caption, clean and uncluttered for easy scanning.
