---
title: "Tools That Can Help You Understand Utility Use"
...
**Who it's for:** Households where heating and cooling make up 40–50% of energy use (EIA RECS data) and where the thermostat schedule does not match occupancy — a classic adjustment that DOE says can save up to 10% per year by setting back 7–10°F for 8 hours a day.
...
1. Compare the current bill with a similar prior billing period.
2. Identify whether the issue is electricity, gas, water, or a billing question.
3. Measure or inspect the specific issue before buying hardware.
