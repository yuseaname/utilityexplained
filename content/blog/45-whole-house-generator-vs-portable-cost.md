...
keywords: ["portable generator safety", "standby generator planning", "backup power", "generator transfer switch"]
...
{{< product-box asin="B000Q5VMKG" name="First Alert CO615 Plug-In Carbon Monoxide Alarm" label="The alarm that guards the generator" description="Electrochemical sensor, plug-in with AA battery backup, backlit digital CO readout, UL 2034 listed, 7-year warranty (First Alert spec). CPSC's guidance — every level, outside sleeping areas — makes this the second half of any portable-generator purchase." button="Check price on Amazon" >}}

## The Three Ways to Connect a Portable
...
| Method | What it powers | Typical installed cost | Notes |
|---|---|---|---|
| **Extension cords** | Only plug-in devices, via a generator cord | Cord only | The no-install fallback; cannot reach hardwired loads (well pump, furnace blower); never run cords through walls or doorways |
| **Interlock kit** on the main panel | Any circuits the panel feeds, one at a time | ~$200–$400[5] | Must be listed for your exact panel brand; simplest path for 240 V loads; requires electrician + permit in most jurisdictions |
...
{{< product-box asin="B000BQN4T2" name="Reliance Controls Pro/Tran 6-Circuit Transfer Switch Kit (31406CWK)" label="The safe portable-to-panel link" description="30 A, 6-circuit pre-wired kit rated for generators up to 7,500 W — includes the power inlet box, 10-ft L14-30 cord, and breaker; cUL listed to UL 1008; 5-year warranty (Reliance spec). This is the manual-transfer-switch path from the table above, bought as one scoped kit your electrician wires in a day." button="Check price on Amazon" >}}

If you stay on cords for now, use a purpose-built generator cord rated for the full load—

{{< amazon asin="B005Z17WLE" text="See the Champion 48036 25-ft 30A generator cord on Amazon" >}} — L14-30 plug to four household outlets, SJTW 10-gauge, rated to 7,500 W, lighted ends.
...
- Related reading: if the underlying issue is a [furnace blowing cold air](/blog/why-is-my-furnace-blowing-cold-air/) or an outage-driven [sudden spike in your electric bill](/blog/30-sudden-spike-in-electricity-bill-no-usage/), fix the diagnosis before buying backup for it.
...
|---|---|
| Equipment | Exact model, fuel, rated output, and manufacturer requirements |
| Connection | Transfer equipment (NEC 702), panel work, grounding, and isolation method[5] |
| Site work | Location and clearances, permits, gas or fuel work, and access |
| Loads | Which circuits or equipment the design is intended to serve |
| Maintenance | Owner tasks, service intervals, and warranty conditions |
| Total cost | Equipment, labor, permits, site work, fuel work, and exclusions |
...
{{< faq "How far does a portable generator need to be from the house?" >}}
...
{{< faq "Is an interlock kit as safe as a transfer switch?" >}}
...
{{< faq "Can a portable generator run my central AC?" >}}
...
1. [CPSC Release 26-519 (May 2026): generator CO hazards — outdoors only, at least 20 feet, exhaust away from openings](https://www.cpsc.gov/Newsroom/News-Releases/2026/CPSC-Warns-of-Generator-Carbon-Monoxide-and-Fire-Hazards-Ahead-of-Hurricane-Season)
2. [CPSC (2024): Winter storm CO prevention — "nearly 100 consumers die…each year" from portable-generator CO; battery CO alarms every level and outside sleeping areas](https://www.cpsc.gov/Newsroom/News-Releases/2024/As-Winter-Storms-Continue-CPSC-Urges-Families-to-Take-Steps-to-Prevent-Carbon-Monoxide-Poisoning-and-Fires)
3. [CPSC Safety Guide: Generators and Engine-Driven Tools (one generator ≈ hundreds of cars' CO; never indoors)](https://www.cpsc.gov/Safety-Education/Safety-Guides/Carbon-Monoxide-Home/Generators-and-Engine-Driven-Tools)
4. [Federal Register (Apr 2023): Safety Standard for Portable Generators — 1,332+ deaths reported; generators ≈ 40% of consumer-product CO deaths](https://www.federalregister.gov/documents/2023/04/20/2023-07870/safety-standard-for-portable-generators)
5. [AZDC Electric: Interlock Kit vs Transfer Switch (interlock $200–$400 installed; MTS $300–$600; permits; NEC 702 transfer equipment; backfeed danger)](https://azdcelectric.com/generator-interlock-kit-vs-transfer-switch/)
6. [Consumer Reports: Portable vs Standby Generators (class ranges 2,500–8,500 W / 8,000–22,000 W; fuel 12–20 gal/day; hardware costs; transfer-switch capability)](https://www.consumerreports.org/home-garden/generators/portable-vs-standby-generator-which-is-right-for-your-home-a1183970467/)
7. [Generac: Backup generator installation — $8,000–$16,000 installed including the generator](https://www.generac.com/resources/home-management/backup-generator-installation/)
8. [Norwall (Generac dealer): Guardian 10–26 kW classes, NG/LP, bundled ATS, equipment price points $4,189–$7,639](https://norwall.com/categories/standby-generators/generac-guardian-generators/)
9. [Bob Vila: Portable vs Standby Generators (standby $8,000–$16,000+; ~7,500–10,000 W portable capability bands)](https://www.bobvila.com/exterior/portable-vs-standby-generators-for-home/)
10. [Generac Support: What Does Surge/Starting Wattage Mean?](https://support.generac.com/s/article/What-Does-Surge-Starting-Wattage-Mean)
11. [Generac Support: What Does Running/Rated Wattage Mean?](https://support.generac.com/s/article/What-Does-Running-Rated-Wattage-Mean)
12. [Generac Support: Understanding Portable Generator Power Limits vs Advertised Wattage](https://support.generac.com/s/article/Understanding-Portable-Generator-Power-Limits-vs-Advertised-Wattage)
13. [Generac Support: What Is Total Harmonic Distortion (THD) — inverters ≤3% THD](https://support.generac.com/s/article/What-Is-Total-Harmonic-Distortion-THD)
