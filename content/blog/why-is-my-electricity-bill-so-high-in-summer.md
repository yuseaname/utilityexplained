...
{{< product-box asin="B0D5BBYRJM" name="Google Nest Learning Thermostat (4th gen)" label="Cooling-bill automation" description="Learns your schedule and nudges temperatures on its own — Google's own numbers: ~12% off heating and ~15% off cooling bills. The 78°F strategy in this article, running itself." button="Check price on Amazon" >}}
