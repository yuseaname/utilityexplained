...
keywords: ["apartment utility budget", "what utilities do renters pay", "first apartment utilities"]
...
| Item | Questions to get in writing |
|---|---|
| Electricity and gas | Which provider serves the unit, and whose name must be on the account? |
| Water, sewer, and trash | Included in rent, separately metered, allocated, or billed by a third party? |
| Internet | Is a provider required, included, or chosen by the tenant? |
| Shared building services | How are common-area or shared-meter costs handled? |
| Deposits and setup | What provider policies, deadlines, or documents apply? |
