---
title: "Utility Assistance Programs: LIHEAP, Payment Plans, and Hardship Help"
...
- [Emergency: Facing Shut-Off This Week](#emergency-facing-shut-off-this-week)
- [LIHEAP: Federal Energy Assistance](#liheap-federal-energy-assistance)
- [Utility Company Hardship Programs](#utility-company-hardship-programs)
- [State-Specific Assistance Programs](#state-specific-assistance-programs)
- [Weatherization Assistance Program](#weatherization-assistance-program)
- [Non-Profit and Charity Help](#non-profit-and-charity-help)
- [How to Avoid Utility Shut-Off](#how-to-avoid-utility-shut-off)
...
1. **Call your utility's customer service** 
   - Say: "I received a shut-off notice. I need to speak with a hardship representative about payment arrangements."
   - Ask for: payment plan options, hardship program eligibility, medical exemption forms (if applicable), shut-off extension

2. **Document the call**
   - Rep name, case number, what they promised, follow-up date

3. **Call 211**
   - United Way hotline connects you with local charities that pay utility bills
...
- Call **211** and ask for "LIHEAP application site"
- Visit [liheap.org](https://liheap.org) and search by state
...
- Proof of income (last 30–60 days): pay stubs, Social Security award letter, unemployment benefits
- Proof of address (utility bill, lease)
- Current utility bills (electric, gas, oil, propane)
- Shut-off notice (if applying for crisis assistance)

**Step 3: Apply**

| Application Method | How |
|-------------------|-----|
| **In-person** | Visit your local LIHEAP office (fastest) |
...
Most utilities have their own hardship programs, separate from LIHEAP. These are often faster and less bureaucratic.

### Common Utility Programs

| Program Type | What It Offers | Who Qualifies |
|--------------|----------------|---------------|
| **Payment plans** | Extended payment time (3–12 months) | Anyone behind on bills |
| **Budget billing** | Fixed monthly payment (smoothed over 12 months) | Customers in good standing |
| **Hardship discounts** | 10–40% off monthly bill | Income-qualified |
| **Winter protection** | No shut-offs during winter months | Income-qualified or medical need |
| **Medical exemptions** | No shut-offs for medical equipment | Doctor certification required |
...
{{< faq "Can I get help if I'm not low-income?" >}}
Yes, but options are more limited. You can still:
- Set up a **payment plan** (most utilities offer this to anyone)
- Enroll in **budget billing** (smooths seasonal spikes)
