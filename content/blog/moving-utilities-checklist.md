---
title: "The Moving Utilities Checklist: When to Turn Off, Turn On, and Transfer"
...
**Different provider or different territory = close old + open new.** If you're moving across a service boundary, the old account gets a final bill and the new one starts fresh. That fresh start often means a [deposit](/blog/26-utility-deposit-explained/) — especially if your credit check comes back thin. Budget for it, and ask whether the new provider will waive it if you set up autopay or provide a letter of good standing from your old utility.
...
**Connection fees.** The new provider may charge a [connection fee](/blog/27-utility-connection-fee-explained/) to turn the service on — a flat amount separate from any deposit. Ask for it in writing when you schedule, so there's no surprise on the first bill.
...
**Be present for the final reading if you can.** When the utility schedules the final meter read, try to be there. If you can't, take your own photo of the meter on move-out day with the date visible. That photo is your evidence if the final bill doesn't match. If you're not sure how to read the dials, check our guides for [electric](/blog/how-to-read-electric-meter/), [gas](/blog/how-to-read-gas-meter/), and [water](/blog/how-to-read-a-water-meter/) meters before you go.
...
Sometimes, but it's risky. A same-day transfer depends on the provider's schedule and whether a technician needs to visit. If the connection requires a visit, you may not get same-day service. Schedule the turn-on for the day before you arrive so you're never left without power.
{{< /faq >}}

{{< faq "What happens to my utility deposit when I move?" >}}
Your old deposit is usually refunded after the final bill is settled — not before. If you're staying with the same provider, ask whether the deposit can be transferred to the new account. If you're opening a new account elsewhere, expect a possible new deposit based on a fresh credit check.
{{< /faq >}}

{{< faq "Do I need to be home for the utility connection?" >}}
It depends on the service and the provider. Electric and gas connections sometimes require someone to be present, especially if the meter needs to be accessed or the service was off for a while. Water is often connected without you present. Ask when you schedule whether a visit is required and what the window is.
{{< /faq >}}
