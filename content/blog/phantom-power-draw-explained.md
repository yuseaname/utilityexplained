...
A plug-in power meter can measure a device's use in standby or other low-power modes.[1] When a reading fluctuates, DOE advises measuring energy over a period and dividing by the measurement time to find average power.[1]

1. Plug the meter into the outlet and the device into the meter.
2. Put the device in the low-power mode you normally use.
3. Let the reading stabilize, or record energy over time if it varies.
4. Prioritize devices whose low-power functions you do not need.
