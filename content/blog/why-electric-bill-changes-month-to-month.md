...
**An electric bill can change even when total kWh is similar because the billing period, rate plan, time of use, and listed charges can differ.** Read the current statement and tariff before assigning a cause.
...
<h2 id="demand-charges">Demand charges: the spike you did not feel</h2>
<p>
...
<h2 id="delivery-vs-supply">Delivery vs supply: two moving parts</h2>
<p>
...
<h2 id="meter-timing">Meter read timing and estimated reads</h2>
<p>
...
{{< faq "Why does my electric bill change every month?" >}}
...
- [U.S. Energy Information Administration: Electric Power Monthly retail-sales data](https://www.eia.gov/electricity/monthly/epm_table_grapher.php?t=epmt_5_6_a) — current official electricity-sales and price data.
