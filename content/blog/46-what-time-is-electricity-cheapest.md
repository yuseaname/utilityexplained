...
keywords: ["cheapest electricity hours", "time of use electricity", "electricity rate plan", "cheapest time to use electricity", "off-peak hours"]
...
## A Note on Your Exact Hours

Do not assume the hours in the table above apply to you. Check your utility’s current tariff or call their customer service to confirm:

- The exact peak, off-peak, and super-peak windows (some plans have two or three tiers).
- Whether the schedule changes by season (summer vs. winter hours).
- Whether weekends and holidays are treated as off-peak or follow a special schedule.
- Whether the rate structure is flat, tiered, or includes demand charges alongside the TOU component.

Your utility’s rate-plan hub has links to each utility’s tariff. If you are shopping for a new plan, [Power to Choose](https://www.powertochoose.org) (Texas) or your state’s disclosure page will list the TOU windows for each offer.
