...
If you live in a state with energy choice (deregulated market), you've probably seen offers to "lock in" your electricity or gas rate for 12–36 months. Is that a good deal? Should you float with the market instead? Or is there a third option?

This guide breaks down fixed vs variable utility rates, explains when each makes sense, and gives you a decision framework.

<img src="https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=1200&h=630&fit=crop&q=80" alt="Comparing fixed and variable utility rate plans" width="1200" height="630" loading="lazy" />

## Table of Contents

- [What are fixed and variable rates?](#what-are-fixed-and-variable-rates)
- [Deregulated vs regulated markets](#deregulated-vs-regulated-markets)
- [Fixed rate pros and cons](#fixed-rate-pros-and-cons)
- [Variable rate pros and cons](#variable-rate-pros-and-cons)
- [The third option: budget billing](#the-third-option-budget-billing)
- [Rate comparison calculator](#rate-comparison-calculator)
- [How to choose the right plan](#how-to-choose-the-right-plan)
- [Watch out for these gotchas](#watch-out-for-these-gotchas)
- [FAQ](#faq)
...
### Fixed rate
You pay the **same price per unit** (per kWh for electricity, per therm for gas) for the duration of your contract — typically 6, 12, 24, or 36 months. The rate doesn't change regardless of market conditions.

**What's fixed:** The supply charge (the cost of the energy itself).
...
### What's a good rate per kWh in 2026?
...
### Should I lock in during summer or winter?
...
### How do I find the best rate in my area?
