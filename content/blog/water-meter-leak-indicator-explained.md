...
<p>Many water meters include a <strong>small dial, triangle, star, or digital flow indicator that moves when water flows through the meter</strong>. Designs differ by meter and utility.</p>
<p><strong>The practical rule:</strong> if an indicator keeps moving after you have stopped known water use, water is still flowing. Confirm that result with two meter readings before deciding the cause; a toilet, irrigation system, appliance cycle, or a leak can all create flow.</p>
...
<li>No sprinklers (including "smart" schedules)</li>
<li>No ice maker or refrigerator water dispenser</li>
</ul>

<h3>Step 2: Wait a few minutes</h3>
<p>Toilets refill quietly after a flush. Waiting helps you avoid mistaking a normal refill for a leak.</p>

<h3>Step 3: Watch the indicator for 60–120 seconds</h3>
<p>If it is truly still, the meter is not showing continuous flow at that moment. If it creeps, spins, or pulses steadily, water is moving through the meter and you need to identify the source.</p>
...
<p>Turn off the home's main shutoff valve. If the leak indicator stops, the flow is inside the home.</p>
<p>If it keeps moving, the flow may be:</p>
<ul>
<li>A leak on the service line (meter to house)</li>
<li>A hose bib or irrigation tee that is before the shutoff</li>
</ul>
...
{{< faq "Should the leak indicator move when everything is off?" >}}
No. If all water use is truly off, the leak indicator should stop. If it keeps moving steadily for 60–120 seconds, something is using water or there is a leak.
{{< /faq >}}

{{< faq "What is the most common cause of hidden water use?" >}}
Toilets are the most common cause because a flapper leak can run quietly for hours or days. Irrigation issues (stuck valves, broken heads) are a close second, especially in summer.
{{< /faq >}}

{{< faq "How long should I watch the leak indicator?" >}}
Watch it for at least 60–120 seconds. For the most reliable answer, take two photos of the meter reading 10–15 minutes apart with everything off — any increase confirms water moved through the meter.
{{< /faq >}}

{{< faq "How do I find my water meter?" >}}
Most residential water meters are in a concrete or plastic box near the street, sidewalk, or curb, often at the front of the property. Lift the lid with a screwdriver or pliers and look for a round metal face with a glass cover.
{{< /faq >}}

{{< faq "Can a slow leak indicator be serious?" >}}
Yes. A slow, continuous flow can add up over a billing period. Confirm the source and contact your utility or a qualified plumber when you cannot isolate it safely.
{{< /faq >}}
...
- [U.S. Environmental Protection Agency WaterSense: Leak Detection and Flow Monitoring Devices](https://www.epa.gov/watersense/leak-detection-and-flow-monitoring-devices) — consumer guidance on monitoring water flow and leaks.
