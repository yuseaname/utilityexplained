...
image: "/images/articles/mcf-vs-ccf-vs-therms-on-gas-bill/mcf-vs-ccf-vs-therms-on-gas-bill_hero_v3.webp"
image_alt: "Gas meter units converting from CCF and MCF to therms."
...
<p>You will often see MCF used in commercial billing or in regions where residential usage is high. For example, a large family home in a cold climate might use 30 MCF in January. This is equivalent to 30,000 cubic feet — the same volume a CCF-metered home would see written as 300 CCF. Because the numbers come out smaller, MCF is easier to read for high-volume users.</p>
...
<p>Everything above gets easier once you know where the numbers live on your statement. Open your most recent bill and locate:</p>
<ul>
<li><strong>The usage line</strong> — the metered amount you are being billed for, shown in CCF, MCF, or therms.</li>
<li><strong>The rate line</strong> — what your utility charges per unit. Check whether it says "per CCF," "per MCF," or "per therm"; that tells you your billing unit.</li>
<li><strong>The BTU or adjustment factor line</strong> — if present, this is the factor your utility uses to convert your metered volume into energy before charging you.</li>
</ul>
...
<p>This lets you compare your rate against <a href="/blog/average-utility-bills-by-state-2026/">average utility bills by state (2026)</a> benchmarks. If your calculated rate is significantly higher than the regional average, you may be eligible for a better rate plan or need to investigate your usage.</p>
...
<h3>Scenario C: The MCF Bill (High-Usage Home)</h3>
<ul><li><strong>Usage:</strong> 15 MCF</li><li><strong>Rate:</strong> $10.50 per MCF</li><li><strong>Total Supply Cost:</strong> 15 × $10.50 = $157.50</li><li><strong>Energy Equivalent:</strong> 15 × 10.37 = 155.55 Therms</li><li><strong>True Cost per Therm:</strong> $157.50 / 155.55 = $1.01 per Therm</li></ul>

{{< visual src="/images/articles/mcf-vs-ccf-vs-therms-on-gas-bill/three-scenario-stubs.webp" alt="Three generic gas bill scenarios converted to per-therm cost." wide="true" >}}
...
<li><a href="/blog/07-gas-bill-too-high/">Why your gas bill is so high — 10 causes ranked</a> — the next step once your per-therm rate or usage looks abnormal.</li>
<li><a href="/blog/average-utility-bills-by-state-2026/">Average utility bills by state (2026)</a> — benchmark your converted rate against regional averages.</li>
...
{{< faq "How do I convert therms back to CCF to match my bill?" >}}

Divide by 1.037 instead of multiplying. If your bill shows 100 therms and you want the equivalent volume figure, 100 / 1.037 is about 96 CCF. This is handy when a rebate program, lease agreement, or comparison tool quotes usage in CCF while you have been tracking therms.
