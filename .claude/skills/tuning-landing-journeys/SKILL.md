...
description: |
  ...
  Use when: implementing or refactoring Tuning Landing Journeys work, troubleshooting conversion optimization, content copy, distribution, or aligning new changes with the repository's existing conventions
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Tuning Landing Journeys Skill

This fallback skill keeps Tuning Landing Journeys work aligned with the conventions already present in this repository. Prefer extending the closest existing implementation over inventing a new abstraction, and verify neighboring states before finishing.
...
```sh
rg -n "tuning-landing-journeys|conversion-optimization|content-copy|distribution" .
rg --files | rg "tuning-landing-journeys|conversion-optimization|content-copy"
```
...
**When:** The task touches conversion optimization in Tuning Landing Journeys work.
...
**When:** The task touches content copy in Tuning Landing Journeys work.
...
**When:** The task touches distribution in Tuning Landing Journeys work.
