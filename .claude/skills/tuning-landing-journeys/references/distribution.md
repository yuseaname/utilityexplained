# Tuning Landing Journeys Distribution Reference

## When To Use

Use this reference when the task touches distribution while working on Tuning Landing Journeys code in this repository.
