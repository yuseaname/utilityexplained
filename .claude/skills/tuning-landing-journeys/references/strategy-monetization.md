# Tuning Landing Journeys Strategy Monetization Reference

## When To Use

Use this reference when the task touches strategy monetization while working on Tuning Landing Journeys code in this repository.
