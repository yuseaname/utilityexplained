# Instrumenting Product Metrics Activation Onboarding Reference

## When To Use

Use this reference when the task touches activation onboarding while working on Instrumenting Product Metrics code in this repository.
