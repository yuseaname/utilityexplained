# Instrumenting Product Metrics Engagement Adoption Reference

## When To Use

Use this reference when the task touches engagement adoption while working on Instrumenting Product Metrics code in this repository.
