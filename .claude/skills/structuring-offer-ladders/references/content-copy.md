# Structuring Offer Ladders Content Copy Reference

## When To Use

Use this reference when the task touches content copy while working on Structuring Offer Ladders code in this repository.
