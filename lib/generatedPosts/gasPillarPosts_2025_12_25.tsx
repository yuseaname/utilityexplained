...
export const gasPillarPosts_2025_12_25: Post[] = [
  {
    ...
    sections: [
      {
        id: "problem-opening",
        title: "The winter gas bill problem (and why it feels so confusing)",
        content: (
          <>
            <p>
      ...
      {
        id: "why-winter-drives-therms",
        title: "The big idea: winter heating drives therms",
        content: (
          <>
            <p>
      ...
      {
        id: "common-drivers",
        title: "Most common drivers of a high winter gas bill",
        content: (
          <>
            ...
            <p>
              Efficiency also changes with maintenance and condition. A struggling
              furnace can short-cycle or run longer than expected. If your home feels
              unevenly heated, takes longer to warm up, or you notice unusual furnace
              behavior, those are clues to investigate.
            </p>
            <h3>5) Hot water and other baseline loads</h3>
            <p>
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <p>
              Your bill typically has a supply (commodity) portion and a delivery
              (distribution) portion. Either can change due to rate adjustments,
              seasonal factors, or regulatory updates. Even if your household usage
              is flat, a rate increase can push the total up.
            </p>
            <p>
              If you want the cleanest breakdown of what those terms mean, read
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              The goal is confidence, not perfection. These checks help you decide
              whether the bill is plausible or whether you should dig deeper.
            </p>
            <h3>Check 1: therms per day vs last year</h3>
            <p>
      ...
      {
        id: "diagnose-bill-lines",
        title: "Use the bill lines to diagnose the spike (supply vs delivery)",
        content: (
          <>
            <p>
            ...
            <p>
              ...
              used) and <strong>delivery</strong> (the system that brings it to you).
              If you want a clear explanation of those categories, read
              <a href="/blog/gas-delivery-charge-vs-supply-charge">
                delivery vs supply charges
              </a>
              .
            </p>
            <h3>Three quick questions to ask your bill</h3>
            <ol>
              <li>
                Did <strong>therms</strong> increase (usage)?
              </li>
              <li>
                Did the <strong>supply price per therm</strong> change (commodity
                pricing)?
              </li>
              <li>
                Did the <strong>delivery section</strong> change (rates/fees) even
                if therms were similar?
              </li>
            </ol>
            <p>
              If therms are up, focus first on usage drivers (weather, equipment,
              schedule, comfort settings). If therms are flat but the total rose,
              the answer is usually rate changes, billing days, or a one-time
              adjustment.
            </p>
          </>
        )
      ...
      {
        id: "winter-playbook",
        title: "A winter spike playbook (what to do this week)",
        content: (
          <>
            <p>
            ...
            <p>
              Divide total therms by billing days. This prevents false alarms when
            ...
            <p>
              In many homes, <strong>space heating</strong> dominates winter gas
              usage. But water heating, a gas dryer, or a fireplace can still
              matter. If you have a smart thermostat, note daily runtime and look
            ...
            <p>
              Walk the house and feel around exterior doors, attic access, and
            ...
            <p>
              ...
              total runtime without compromising comfort.
            </p>
            <h3>7) Rule out abnormal hot water usage</h3>
            <p>
              A running hot-water tap, a recirculation pump left on, or a hot-water
              leak can move a surprising amount of energy. If this sounds possible,
              also review your water patterns; the water hub is
              <a href="/water-explained"> here</a>.
            </p>
      ...
      {
        id: "worked-example",
        title: "A worked example: separating days, usage, and rates",
        content: (
          <>
            <p>
            ...
            <ul>
              <li>Last cycle: 80 therms over 28 days = 2.86 therms/day</li>
              <li>This cycle: 120 therms over 33 days = 3.64 therms/day</li>
            </ul>
            <p>
              Usage increased by about <strong>27%</strong> on a per-day basis.
              That could easily be explained by a colder month, longer runtime, or
            ...
            <p>
              ...
              noticeable jump. If you want to validate the units and conversions
              involved, the cleanest explanation is
              <a href="/blog/mcf-vs-ccf-vs-therms-on-gas-bill"> this units guide</a>.
            </p>
          </>
        )
      },
      {
        id: "misconceptions",
        title: "Common misconceptions about winter gas bills",
        content: (
          <>
            <ul>
              <li>
            ...
            <p>
              If the confusing part is the unit math (CCF/MCF/therms), the explainer
              you want is
              <a href="/blog/mcf-vs-ccf-vs-therms-on-gas-bill">
                MCF vs CCF vs therms
              </a>
              .
            </p>
          </>
    ...
    faqs: [
      {
        question: "Why does my gas bill go up so much in winter?",
        answer:
      ...
      {
        question: "How can I compare gas bills fairly month to month?",
        answer:
          "Use therms per day. Divide total therms by the number of days in the billing period to separate longer cycles from real usage changes."
      },
      {
        question: "Can my bill be higher even if I used fewer therms?",
        answer:
          "Yes. Supply rates, delivery rates, and fixed customer charges can change. A rate increase can raise the total even when usage is flat or slightly lower."
      },
      {
        question: "What is the first thing to check if my winter bill spikes?",
        answer:
          "Start with billing days and therms per day, then check whether the meter read was estimated. After that, compare to the same month last year for context."
      }
    ],
    relatedSlugs: [
      "how-to-read-your-gas-bill-therms-explained",
  ...
  },
  {
    ...
    image: {
      ...
      alt: "Close-up of utility meter dials"
    },
    sections: [
      {
        id: "start-here",
        title: "Start here: gas is billed by energy, not just by volume",
        content: (
          <>
            <p>
            ...
            <p>
              For the full overview of how gas service and billing works, see
              <a href="/gas-explained">Natural Gas Explained</a>.
              This article zooms in on the units.
            </p>
          </>
        )
      },
      {
        id: "definitions",
        title: "Definitions: cubic feet, CCF, MCF, BTUs, and therms",
        content: (
          <>
            <p>
            ...
            <ul>
              <li>
                <strong>CCF</strong> = 100 cubic feet (hundred cubic feet)
              </li>
              <li>
                <strong>MCF</strong> = 1,000 cubic feet (thousand cubic feet)
              </li>
            </ul>
            <p>
        ...
        content: (
          <>
            ...
            <ul>
              ...
              <li>Conversion factor: 1.05</li>
              <li>Billed usage: 89.25 therms</li>
            </ul>
            <p>
      ...
      {
        id: "sanity-check-math",
        title: "How to sanity-check the math on your gas bill",
        content: (
          <>
            <p>
            ...
            <p>
              Some utilities show both volume and therms. Others show only therms.
              If you only see therms, the conversion may happen behind the scenes.
            </p>
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              These are common reasons your quick math might not match the bill
              exactly:
            </p>
            <ul>
              <li>
                <strong>Rounding:</strong> the bill may round therms or factors to a
                certain decimal place.
              </li>
              <li>
                <strong>Billing period timing:</strong> the meter read date may not
                match the calendar month.
              </li>
              <li>
                <strong>Adjustments:</strong> corrected reads or prior-period
                adjustments can shift therms.
              </li>
              <li>
                <strong>Separate rate blocks:</strong> some utilities apply different
                rates to different usage tiers.
              </li>
            </ul>
            <p>
              If you also feel confused by the non-usage charges, the clearest model
              is
              <a href="/blog/gas-delivery-charge-vs-supply-charge">
                delivery vs supply charges
              </a>
      ...
      {
        id: "definitions-cheat-sheet",
        title: "A quick cheat sheet: what each unit means",
        content: (
          <>
            <p>
              Keep one simple mental model: your meter often measures
              <strong> volume</strong>, but your bill prices <strong>energy</strong>.
              These units sit on either side of that conversion.
            </p>
            <ul>
              <li>
              ...
              <li>
                <strong>MCF:</strong> 1,000 cubic feet.
              </li>
              <li>
                <strong>BTU:</strong> a unit of heat energy (British Thermal Unit).
              </li>
              <li>
                <strong>Therm:</strong> 100,000 BTUs (an energy unit).
              </li>
            </ul>
            <p>
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <ul>
              <li>Usage: 45 CCF</li>
              <li>Heat content / therm factor: 1.03 therms per CCF</li>
            </ul>
            <p>
            ...
            <p>
              ...
              If it shows something materially different, look for:
            </p>
            <ul>
              <li>Different read dates than you assumed</li>
              <li>A second factor (pressure/temperature compensation)</li>
              <li>A different heat-content value for that period</li>
      ...
      {
        id: "compare-apples",
        title: "How to compare usage fairly (month-to-month and home-to-home)",
        content: (
          <>
            <p>
              The most common mistake with gas comparisons is using the wrong
              denominator. A better comparison stack looks like this:
            </p>
            <ol>
              <li>
                <strong>Therms per day</strong> to account for billing days.
              </li>
              <li>
                <strong>Therms per heating degree day</strong> (if you track it) to
                account for weather.
              </li>
              <li>
                <strong>Therms per square foot</strong> only as a rough cross-home
                comparison, since insulation, leakage, and occupancy matter.
              </li>
            </ol>
            <p>
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <h3>3) The billed unit might be energy, not volume</h3>
            <p>
              Even if your meter is volume-based, your bill might show only therms.
              In that case, the utility is converting volume to energy behind the
              scenes using heat content and (sometimes) pressure/temperature
              adjustments.
            </p>
            <p>
              If your goal is to understand the total bill (not just usage), tie
              these unit concepts back to
              <a href="/blog/gas-delivery-charge-vs-supply-charge">
      ...
      {
        id: "mcf-vs-ccf-on-bills",
        title: "Why some bills show CCF and others show MCF",
        content: (
          <>
            <p>
            ...
            <ul>
              <li>
                <strong>High-usage regions:</strong> MCF keeps the numbers smaller
                (e.g., 12 MCF instead of 120 CCF).
              </li>
              <li>
                <strong>Legacy billing systems:</strong> older templates may use one
            ...
            <p>
              The key takeaway: once you know whether the bill is showing volume
              (CCF/MCF) or energy (therms), the rest becomes a bookkeeping problem,
              not a mystery.
            </p>
          </>
        )
      },
      {
        ...
        title: "Common misconceptions about gas units",
        content: (
          <>
            <ul>
              <li>
    ...
    faqs: [
      {
        question: "What is MCF on a gas bill?",
        answer:
      ...
      {
        question: "What is CCF on a gas bill?",
        answer:
          "CCF means 100 cubic feet of gas (a volume unit). It may appear on bills or meter readings, often alongside a conversion factor to therms."
      },
      {
        question: "Why do gas bills use therms?",
        answer:
          "Therms measure energy (1 therm = 100,000 BTUs). Because heat content per cubic foot can vary slightly, billing by therms helps align what you pay with the energy you actually received."
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        id: "simple-model",
        title: "The simple model: gas as a product + a delivery service",
        content: (
          <>
            <p>
            ...
            <p>
              This article explains those two categories in plain English and gives
              you a quick checklist to interpret changes.
              For the broader overview of gas service, start with
              <a href="/gas-explained">Natural Gas Explained</a>.
            </p>
          </>
        )
      ...
      {
        id: "supply",
        title: "Supply (commodity) charges: what they usually include",
        content: (
          <>
            <p>
      ...
      {
        id: "delivery",
        title: "Delivery (distribution) charges: what they usually include",
        content: (
          <>
            <p>
              The <strong>delivery charge</strong> covers the cost of getting gas to
              your home reliably. It often includes:
            </p>
            <ul>
              <li>Pipelines and distribution mains</li>
              <li>Local neighborhood service lines</li>
              <li>Meters and meter reading systems</li>
              <li>Maintenance, repairs, inspections, and safety programs</li>
              <li>Customer service and billing operations</li>
            </ul>
            <p>
            ...
            <p>
              In places where supplier choice exists, delivery is still paid to the
              local utility because they operate the physical distribution system.
            </p>
          </>
        )
      },
      {
        id: "fixed-charges",
        title: "Customer charges and other fixed fees",
        content: (
          <>
            <p>
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              If you used about the same therms but your total changed, one of these
              is usually responsible:
            </p>
            <ul>
              <li>
                <strong>Rate changes:</strong> supply and/or delivery rates adjusted.
              </li>
              <li>
                <strong>Billing days:</strong> the cycle was longer or shorter.
              </li>
              <li>
                <strong>Estimated reads:</strong> usage shifted due to corrections.
              </li>
              <li>
                <strong>Seasonal pricing:</strong> winter demand often affects costs.
              </li>
            </ul>
            <p>
      ...
      {
        id: "what-to-check",
        title: "What to check on your bill (a short, practical checklist)",
        content: (
          <>
            <ol>
              <li>
                Confirm the billing period length (days).
              </li>
              <li>
                Note total therms and calculate therms per day.
              </li>
              <li>
                Compare supply price per therm to last month.
              </li>
              <li>
                Compare delivery rates/fees to last month.
              </li>
              <li>
                Check whether the meter read was estimated.
              </li>
            </ol>
            <p>
              If the units on your bill are confusing (CCF/MCF/therms), read
              <a href="/blog/mcf-vs-ccf-vs-therms-on-gas-bill">
                MCF vs CCF vs therms
              </a>
              before you try to do any deeper comparisons.
            </p>
          </>
        )
      },
      {
        id: "line-items",
        title: "Common line item names (what they usually mean)",
        content: (
          <>
            <p>
            ...
            <ul>
              <li>
                <strong>Commodity / Gas cost / Supply:</strong> the fuel itself.
              </li>
              <li>
                <strong>Distribution / Delivery / Transportation:</strong> local
                network service that brings gas to your address.
              </li>
              <li>
                <strong>Customer charge / Basic service:</strong> a fixed monthly
                charge for being connected.
              </li>
              <li>
                <strong>Rider / Adjustment / Surcharge:</strong> a component that
                may change periodically (often tied to specific programs).
              </li>
              <li>
                <strong>Taxes / franchise fees:</strong> government-related add-ons.
              </li>
            </ul>
            <p>
              If your bill includes both supply and delivery, compare the two
              sections separately month to month. That habit prevents a lot of
              confusion, because a big jump in one section can hide inside a stable
              overall total.
            </p>
          </>
        )
      },
      {
        ...
        content: (
          <>
            ...
            <p>
              <strong>
                Choosing a supplier typically affects supply charges, not delivery
                charges.
              </strong>
            </p>
            <p>
            ...
            <ul>
              ...
              <li>Contract length and early termination terms</li>
              <li>Fixed vs variable rate structure</li>
      ...
      },
      {
        ...
        title: "A sample bill walkthrough (fictional numbers)",
        content: (
          <>
            <p>
            ...
            <ul>
              <li>Usage: 60 therms</li>
              <li>Supply: $1.40/therm</li>
              <li>Delivery: $0.65/therm</li>
              <li>Customer charge: $15.00</li>
            </ul>
            <p>
            ...
            <p>
              If your total is spiking specifically in winter, pair this supply vs
              delivery framework with
              <a href="/blog/why-is-my-gas-bill-so-high-in-winter">
                the winter spike guide
              </a>
              to see whether the driver is more therms, higher rates, or both.
            </p>
          </>
        )
      },
      {
        id: "marginal-cost",
        title: "Find your marginal cost per therm (the number that matters)",
        content: (
          <>
            <p>
            ...
            <ol>
              <li>Find the supply price per therm (or commodity rate).</li>
              <li>
                Find delivery charges that are per therm (some are fixed, some are
                variable).
              </li>
              <li>Add the per-therm components together.</li>
            </ol>
            <p>
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <ul>
              <li>
                <strong>Therms used:</strong> thermostat settings, run time, drafts,
                equipment maintenance, hot water habits.
              </li>
              <li>
                <strong>Supply price (sometimes):</strong> by choosing a supplier in
            ...
            <ul>
              ...
              <li>
                <strong>Delivery system costs:</strong> delivery rates are set through
                utility rate processes and tend to be stable month-to-month but can
                change over time.
              </li>
              <li>
                <strong>Weather:</strong> but you can normalize comparisons by using
                therms per day.
              </li>
            </ul>
            <p>
              If your main concern is a winter spike, pairing this section with
              <a href="/blog/why-is-my-gas-bill-so-high-in-winter">
      ...
      {
        id: "questions-to-ask",
        title: "Questions to ask if your bill suddenly changed",
        content: (
          <>
            <p>
            ...
            <ul>
              ...
              <li>
                Were there <strong>prior-period adjustments</strong> or corrected reads?
              </li>
              <li>
                Did the supply rate change due to a periodic <strong>gas cost adjustment</strong>?
              </li>
              <li>
      ...
      {
        id: "misconceptions",
        title: "Common misconceptions about delivery vs supply",
        content: (
          <>
            <ul>
              <li>
    ...
    faqs: [
      {
        question: "What is the supply charge on a gas bill?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Delivery often includes significant fixed infrastructure costs and may include both fixed and per-therm components. It can also change due to rate adjustments."
      },
      {
        question: "Can my bill go up even if my therms are the same?",
        answer:
          "Yes. Supply and delivery rates can change, and fixed monthly charges apply regardless of usage."
      }
    ],
    relatedSlugs: [
      "how-to-read-your-gas-bill-therms-explained",
